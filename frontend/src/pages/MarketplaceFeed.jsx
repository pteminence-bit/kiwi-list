...
const MarketplaceFeed = ({ token }) => {
  ...
  return (
    <div className="p-4 md:p-6 bg-slate-50 min-h-screen w-full md:pl-72 flex flex-col items-center">
      ...
      {/* Feed Container: Max-width is locked to 4xl to match the large ListingCard landscape scaling */}
      <div className="w-full max-w-4xl space-y-6">
        
        {/* Top Search & Filter Bar: Spans perfectly in length with the content cards below */}
        ...
        {/* Instagram-Style Feed Track: Cards flow in a unified single column line instead of snapping into a grid */}
